      ...
      <div class="row justify-content-center">
        <div class="col-lg-4">
          ...
          <form method="POST" action="{{ route('register') }}" class="mt-3">
            ...
            <div class="form-group">
              <label>Email</label>
              <input id="email" v-model="email" @change="checkForEmailAvailable()" :class="{ 'is-invalid' : this.email_unavailable}" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
            ...
            <div class="form-group">
              ...
              <input id="password_ation" type="password" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" required autocomplete="new-password">
            ...
            <div class="form-group" v-if="is_store_open">
              ...
              <input id="nama_toko" v-model="nama_toko" type="text" class="form-control @error('nama_toko') is-invalid @enderror" name="nama_toko" value="{{ old('nama_toko') }}" required autocomplete="nama_toko" autofocus>
      ...
      checkForEmailAvailable: function() {
        ...
        axios.get('{{route('api-register-check') }}', {
          ...
          .then(function(response) {
              ...
              self.$toasted.show(
                "Email Terverifikasi, Lanjutkan Ke tahap Berikutnya.",
                {
                  position: "top-center",
                  className: "rounded",
                  duration: 1000,
